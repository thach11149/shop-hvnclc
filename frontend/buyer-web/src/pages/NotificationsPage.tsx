...
import { Bell, CheckCheck, Trash2, Package, Tag, MessageSquare, AlertCircle } from 'lucide-react';
import apiClient from '../api/client';

const TYPE_ICON: Record<string, React.ReactNode> = {
  ORDER: <Package size={16} className="text-blue-500" />,
  PROMOTION: <Tag size={16} className="text-purple-500" />,
  CHAT: <MessageSquare size={16} className="text-green-500" />,
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          {items.map((n: any) => (
            ...
            >
              <div className="mt-0.5 flex-shrink-0">{TYPE_ICON[n.type] || TYPE_ICON.SYSTEM}</div>
